...
void opcontrol() {
    while (true) {
       ...
       /*pros::lcd::print(0, "LF: %f", lF.get_position());
       pros::lcd::print(1, "LM: %f", lM.get_position());
       pros::lcd::print(2, "LB: %f", lB.get_position());
       pros::lcd::print(3, "RF: %f", rF.get_position());
       pros::lcd::print(4, "RM: %f", rM.get_position());
       pros::lcd::print(5, "RB: %f", rB.get_position());
       */
